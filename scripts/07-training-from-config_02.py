...
def train_steering_model(train_dataset, val_dataset, model_save_path, batch_size=64):
    ...
    # Write log file
    model_name = os.path.basename(model_save_path).replace('.pth', '')  # Extract model name from path
...
# Get file pairs - no fiducials
data_dir = "/home/daniel/git/neurips-2025/scripts/carla_dataset_640x480_02/"  # adjust path as needed
