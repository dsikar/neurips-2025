# ViT self-driving car from config, without fiducial markers
...
class CarlaSteering:
    ...
    def process_image(self, image):
        ...
        Convert image from BRG to RGB, no fiducial markers
        """
        ...
        with open(self.prediction_file, "r") as f:
            ...
            if lines:
                try:
                    ...
                    self.prediction_file.unlink()  # Explicitly delete prediction file
        ...
        try:
            ...
            while current_wp_idx < len(self.waypoints):
                ...
                if self.current_image is not None:
                    ...
                    self.current_image = None  # Clear to avoid reprocessing
                    
                    # Save image for external processing
                    self.frame_count += 1
                    image_filename = f"frame_{self.frame_count:06d}.jpg"
                    image_path = self.image_dir / image_filename
                    cv2.imwrite(str(image_path), cv2.cvtColor(img, cv2.COLOR_RGB2BGR)) # does cv2 expect BGR?
                ...
                if not self.image_queue.empty():
                    try:
                        ...
                        pass  # Queue was emptied, continue to next tick
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='best_steering_model_20250514-211326.pth', 
