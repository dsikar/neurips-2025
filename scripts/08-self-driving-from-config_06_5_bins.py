...
class NVIDIANet(nn.Module): # 5 bins (5 classes)
    def __init__(self, num_outputs=5, dropout_rate=0.1):  # Set num_outputs to 15 for the classes
...
class CarlaSteering:
    def __init__(self, config, model_path='model.pth', distances_file='self_driving_distances_06.txt'):
        ...
        # Initialize model
        self.model = NVIDIANet(num_outputs=5)
