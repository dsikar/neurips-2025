...
# Quantized to 5 bins
# waypoints 3 meters 
# Check when 1.5 meters from the waypoint
...
def get_figure8_waypoints(world):
    ...
    waypoints = carla_map.generate_waypoints(3.0) # Generate waypoints every 3 meters
...
def main(config_path='config_640x480_segmented_07_3_bins.json'):
    # Load configuration
...
if __name__ == "__main__":
    main('config_640x480_segmented_07_3_bins_qwen.json')