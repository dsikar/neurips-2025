...
data_dir = "/home/daniel/git/neurips-2025/scripts/carla_dataset_640x480_06/" # segmentation, no fiducials
...
model_save_path = f'best_quantized_steering_model_5_bins_{timestamp}.pth'
