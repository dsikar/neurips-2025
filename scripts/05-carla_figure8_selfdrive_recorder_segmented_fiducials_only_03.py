...
def drive_figure_eight(world, vehicle, waypoints, rgb_camera, config):
    ...
    try:
        ...
        rgb_camera.stop()
        with open(os.path.join(output_dir, 'ground_truth_distances_03.txt'), 'w') as f:
...
def main(config_path='config_640x480_segmented.json'):
    # Load configuration
...
if __name__ == "__main__":
    main('config_640x480_segmented_03.json')